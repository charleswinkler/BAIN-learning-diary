...
* Git ist eine Software zur Verwaltung von Versionen. 
* Heisst so, weil der Linus Torvalden sich schon wieder einen [Scherz](https://de.wikipedia.org/wiki/Git#Name) erlauben wollte. 
