...
Wir besprechen die Aufgaben vom letzten Mal, lernen, wie man XML validieren kann, erfahren zudem, welche andere Werkzeuge vorhanden sind, um Metadaten in andere Formate zu transferieren, erfahren etwas über ein neues Format namens LIDO, und befassen uns dann mit den Suchmaschinen und Discovery-Systemen, indem wir VUFIND installieren. 

## Anreicherungsaufgabe zum letzten Unterricht
Als eine zusätzliche (aber nicht obligatorische) Aufgabe konnte man probieren, die Daten mit lobid-GND anzureichern. Dabei wurde folgendes gesagt. 
### DSpace
...
### XML-Validation
Für die Validierung all unserer transformierten Meta-Daten in XML benutzen wir das in Ubuntu installierte xmllint. Dabei müssen wir in der Datei angeben, dass es eine XML-Datei ist, indem wir folgende Deklaration am Anfang abgeben. 
