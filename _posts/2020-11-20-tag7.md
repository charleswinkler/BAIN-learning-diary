...
Man kann damit Daten, die in einer Form präsentiert werden wie z.B. einem Spreadsheet (ähnlich wie Excel), einer CSV
...
## GREL 
Steht für [General (oder Google) Refine Expression Language](https://github.com/OpenRefine/OpenRefine/wiki/General-Refine-Expression-Language). 
